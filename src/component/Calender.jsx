...
<div className='flex flex-col gap-4 p-4'>
   ...
   <div className='px-6 flex justify-start items-center'>
    ...
    <div>
        <h1 className='text-[1rem] font-poppins w-[30%]'>
            Choose the session time according to chosen date or your else appointment will be get cancelled.
        </h1>
    </div>
    <div className=' cursor-pointer flex justify-center items-center w-[30%] bg-custom-green text-sm text-white p-3 px-22 rounded-lg'>
         Submit Message
    </div>
