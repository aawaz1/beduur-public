...
const Ebook = () => {
    return (
        <div className='flex  flex-col gap-4 p-4'>
            ...
            <div className='w-[80%] mx-auto shadow-lg p-2'>
                ...
                <div className='flex w-[100%] gap-4'>
                    <div className='w-[50%] bg-white'>
                        <div>
                            <h1 className='text-custom-green font-semibold font-poppins p-4 pl-8'>
                                FREE E-BOOK
                            </h1>
                            ...
                            <div>
                                <img src='/14565644_5511048 1.png' />
                            </div>
                    ...
                    <div className='flex flex-col gap-4 p-4 py-16 w-[50%]'>
                        ...
                        <div>
                            <h1 className='text-[1rem] font-poppins w-[70%]'>
                                Choose the session time according to chosen date or your else appointment will be get cancelled.
                            </h1>
                        </div>
                        <div className=' cursor-pointer flex justify-center items-center w-[70%] bg-custom-green text-sm text-white p-3 px-22 rounded-lg'>
                            Get Free E-Book
                        </div>
